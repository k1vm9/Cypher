...
function saveSettings() {
  try {
    ...
    const { atomicWriteFileSync: _aw } = (() => { try { return require('../../utils/atomicWrite'); } catch(_){return{atomicWriteFileSync:fs.writeFileSync};} })();
    _aw(SETTINGS_FILE, JSON.stringify(toSave, null, 2), 'utf-8');
  } catch (_) {}
}
